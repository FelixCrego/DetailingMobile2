  ...
  return (
    <main id="home" className="relative overflow-hidden bg-[#030712] text-white">
      ...
      >
        ...
        <div className="relative mt-12 h-52 w-full max-w-3xl overflow-hidden rounded-3xl border border-cyan-200/25 shadow-[0_16px_60px_rgba(14,116,144,0.35)] md:h-72">
          <Image
            src="https://images.unsplash.com/photo-1542282088-fe8426682b8f?w=2200"
            alt="Sleek sports car highlighted in the hero section"
            fill
